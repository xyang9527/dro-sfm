...
from dro_sfm.geometry.camera_utils import view_synthesis
from dro_sfm.utils.depth import calc_smoothness, inv2depth
...
########################################################################################################################
    ...
    def forward(self, image, context, inv_depths,
        ...
        # print(f"num n:{self.n}, image shape:{image.shape}, inv_depth shape:{inv_depths[0].shape}")
