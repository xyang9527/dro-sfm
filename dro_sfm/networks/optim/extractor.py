...
class ResNetEncoderV2(models.ResNet):
    ...
    def __init__(self, num_layers=18, num_input_images=1, pretrained=True, out_chs=32, stride=8):
        ...
        self.layer4 = self._make_layer(block, 512, layers[3], stride=2)
        # del self.layer4
        self.upconv0 = nn.Sequential(nn.Conv2d(512, 256, 3, 1, padding=1), nn.ReLU(inplace=True))
        self.upconv0_fusion = nn.Sequential(nn.Conv2d(512, 256, 3, 1, padding=1), nn.ReLU(inplace=True))
